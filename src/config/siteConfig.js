...
// SITE CONFIGURATION
//
// Edit this file for routine updates: service descriptions, contact info,
// UEI/SAM status, industries, and nav links. You should not need to touch
// component files to change content.
// =============================================================================
...
export const imagePaths = {
  ...
  bridgeAccent: "/images/bridge-accent.jpg",
  ...
  forContractorsBanner: "/images/for-contractors-banner.jpg",
  teamWithUsBanner: "/images/team-with-us-banner.jpg",
  aboutMissionBg: "/images/about-mission-bg.jpg",
  teamSectionBg: "/images/team-section-bg.jpg",
  resourcesBg: "/images/resources-bg.jpg",
};
...
// -----------------------------------------------------------------------------
// THE FOUR SERVICES
// No pricing appears anywhere on the site — description copy only.
// -----------------------------------------------------------------------------
